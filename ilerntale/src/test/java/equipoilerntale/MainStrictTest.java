...
public class MainStrictTest {
    ...
    @Test
    public void testResolucionYDimensiones() {
        assertTrue("El ancho de la intro debe coincidir con el del juego", GameSettings.INTRO_WIDTH == GameSettings.ANCHO_PANTALLA);
        assertTrue("El alto de la intro debe coincidir con el del juego", GameSettings.INTRO_HEIGHT == GameSettings.ALTO_PANTALLA);
    }
    ...
    public void testBalanceCombate() {
        // Verificar que el daño del zombie sea menor a un porcentaje de la vida total del jugador
